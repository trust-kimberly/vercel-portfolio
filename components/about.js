...
export default function About () {
  return (
    <Stack spacing={6}>
      ...
      <p>A multimedia artist, designer, and developer based in Los Angeles, I am currently open to local and remote opportunities in UI/UX design, web design, and creative coding.</p>
